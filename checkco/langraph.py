...
# Function 5: planning ability (e.g. meta planning, first planning, second planning), example: recognize/generate latex, ppt, pdf, pictures of apple stock/company financial data 

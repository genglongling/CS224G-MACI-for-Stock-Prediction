...
# Function 5: planning ability (e.g. meta planning, first planning, second planning), example: generate a plan, through pdf -> recognize/generate latex, ppt, pdf, pictures
